  ...
  methods: {
    ...
    handleQuery() {
      if (this.queryParams.roleName) {
        if (!this.checkSpecialKey(this.queryParams.roleName)) {
          this.$message({
      ...
      if (this.queryParams.roleKey) {
        if (!this.checkSpecialKey(this.queryParams.roleKey)) {
          this.$message({
            message: "搜索内容不能包含特殊字符！",
            type: "error",
          });
    ...
    /** 提交按钮 */
    submitForm: function () {
      if (this.form.roleName&&!this.checkSpace(this.form.roleName)) {
        this.$message({
          message: "角色名称不能为空字符！",
          type: "error",
        });
      ...
      if (this.form.roleKey&&!this.checkSpace(this.form.roleKey)) {
        this.$message({
          message: "权限字符不能为空字符！",
          type: "error",
        });
