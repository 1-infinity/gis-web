      ...
      <div>
        <div>
          ...
          <div v-if="ChosedItem.indexOf('1-1')!==-1">
            ...
            <p>
              <modify class="update">
                深入贯彻习近平总书记视察广东重要讲话精神和重要批示指示精神，落实中央和省、市关于防灾减灾救灾及应急管理的要求。
              </modify>
<!--              <span type="button"-->
<!--                    class="monitor-info" content="深入贯彻习近平总书记视察广东重要讲话精神和重要批示指示精神，落实中央和省、市关于防灾减灾救灾及应急管理的要求。">?</span>-->
              坚持以防为主、防抗救相结合，坚持常态救灾和非常态救灾相统一，努力实现“三个转变”，做好我市洪涝灾害的防御和抢险救灾工作，提高快速反应和应急处置能力，最大限度地减少人员伤亡和财产损失，保障经济社会平稳发展。
            </p>
          </div>
          <div v-if="ChosedItem.indexOf('1-2')!==-1">
            ...
            <p>
              依据
              <modify class="update">
                《中华人民共和国突发事件应对法》《中华人民共和国防洪法》《中华人民共和国水法》《中华人民共和国防汛条例》《中华人民共和国河道管理条例》《气象灾害防御条例》
                《中华人民共和国水文条例》《水库大坝安全管理条例》《蓄滞洪区运用补偿暂行办法》《突发事件应急预案管理办法》《广东省突发事件应对条例》《广东省防汛防旱防风条例》《广东省突发事件总体应急预案》《广东省防汛抗旱防风防冻应急预案》《深圳市突发事件总体应急预案》《深圳市防洪防风规定》《深圳市台风暴雨灾害防御规定（试行）》
              </modify>
<!--              <span type="button" class="monitor-info" data-container="body" data-toggle="popover" data-placement="top"-->
<!--                    data-content="替换成自己所需的对应的法案">?-->
<!--              </span>-->
              等法律法规及有关规定，制订本预案。            </p>
          </div>
...
<!--              <span type="button" class="monitor-info" data-container="body" data-toggle="popover" data-placement="top"-->
<!--                    data-content="可以改成（本市）">?-->
<!--              </span>-->
              范围内暴雨、洪水、内涝等灾害的防御及抢险救灾工作。            </p>
          </div>
          <div v-if="ChosedItem.indexOf('1-4')!==-1">
            <h2>1.4 编制原则</h2>
            <p>
              (1) 以人为本，减少损失。以保障人民群众的生命财产安全作为应急救援工作的出发点和落脚点，最大限度地减轻暴雨、洪水、内涝等带来的人员伤亡、财产损失和社会影响。以人为本，减少损失。以保障人民群众的生命财产安全作为应急救援工作的出发点和落脚点，最大限度地减轻暴雨、洪水、内涝等带来的人员伤亡、财产损失和社会影响。
            </p>
            <p>
              (2) 统一领导，分级负责。在市委市政府的统一领导下，实行行政首长负责制，按照行政区域实行属地管理，各区<modify class="update">
                （含新区、深汕特别合作区，下同）
              </modify>是本行政区域内防汛工作的责任主体，体现防汛工作统一领导、统一指挥、分级分行业负责的原则。是本行政区域内防汛工作的责任主体，体现防汛工作统一领导、统一指挥、分级分行业负责的原则。
            </p>
            <p>
        ...
        <div>
          <h1 v-if="ChosedItem.some(item => item.startsWith('2'))">2 灾情分析与防灾体系</h1>
          ...
          <div v-if="ChosedItem.indexOf('2-1')!==-1">
            <h2>2.1 洪涝灾害特点</h2>
            <pre><modify class="update">（1）时间分布不均。我市洪涝灾害发生时间通常为3月至10月， 其中，3月下旬到清明节前后、5月“龙舟水”、6月至9月，台风影响较强，暴雨发生频度大，洪涝灾害风险高。
...
（4）海潮顶托使洪涝影响加重。我市入海河流多，下泄洪水遇到高潮位时，受海潮顶托水位抬升，洪涝影响加重。南山区、宝安区沿珠江口区域受到珠江洪峰顶托，情况更为严重。</modify></pre>
          </div>
          <div v-if="ChosedItem.indexOf('2-2')!==-1">
            <h2>2.2 典型灾情回顾</h2>
            <pre><modify class="update">2000-2018年，我市共发生36起影响较大、损失较重的暴雨洪涝灾害，平均每年2次左右。
...
2018年8月27日-9月1日，广东省出现持续强降水过程，珠三角南部市县、粤东地区出现持续性特大暴雨；惠州市高潭镇录得1056.7毫米的日雨量和1394.6毫米的过程累积雨量，均刷新广东省历史极值。8月29-31日，我市出现历史罕见的连续3天局地特大暴雨，为1952年有气象历史记录以来首次。期间最大12小时雨量(333.9毫米)、最大24小时雨量（417.2毫米）、最大48小时雨量（486.9毫米）均打破有气象记录以来8月降雨记录。全市发生多座水库超防洪限制水位，出现多处严重内涝积水点，多处交通和供电中断、山体滑坡等险情。其中，下坪固体废弃物填埋场出现多处山体滑坡、滑坡体挤压危化品存储罐、供电长时间中断等严重险情。</modify></pre>
          </div>
          <div v-if="ChosedItem.indexOf('2-3')!==-1">
            <h2>2.3 防灾工程体系</h2>
            <pre><modify class="update">（1）全市（含深汕特别合作区，下同）共有水库189宗（含在建），总控制集雨面积约649平方公里，其中，中型以上水库16宗，小型水库173宗，总库容9.89亿立方米。
...
（4）全市共有大小排涝泵站139座，总装机流量919m3/s。其中规模以上（装机流量1m3/s及以上或装机功率50kW及以上）泵站115座，总装机流量910m3/s；规模以下（装机流量1m3/s及以下且装机功率50kW及以上）泵站24座，总装机流量9m3/s。
（5）全市共建有水闸213座，其中，规模以上（过闸流量5m3/s及以上）水闸150座，规模以下（过闸流量1m3/s至5m3/s之间）水闸62座，过闸流量小于1m3/s水闸1座。
...
（7）全市共有临时避难场所555个，社区临时避难场所覆盖率约75%，可容纳安置人数约25万人，基本可满足临时性的紧急安置需求。</modify></pre>
          </div>
          <div v-if="ChosedItem.indexOf('2-4')!==-1">
            <h2>2.4 防灾重点</h2>
            <pre><modify class="update">我市易涝区域主要分布在茅洲河流域片区（宝安区福海、松岗、沙井街道，光明区公明街道），龙岗河流域片区（龙岗区龙岗、坪地街道，坪山区坑梓街道），坪山河流域片区（坪山区坪山街道），宝安区西部，南山区前海等地面高程较低的片区。河流沿岸、城区低洼处是洪涝灾害高风险区域，在建工程、病险水库、危险边坡周边是险情灾情高发区，组织防御和抢险救灾的工作重点是上述区域的预案落实、巡查警戒和紧急情况处置。
...
　　（7）东部沿海防洪分区
　　东部沿海区域主要包括盐田区及大鹏新区。区域内的风险因子主要包括海潮及小流域洪水。该分区属沿海海岸地貌，多高山陡坡，地质条件较好，自然的山体成为良好的防护屏障，大部分区域不需要人为建设防潮工程。该分区河流短小，各河流水系相互独立，洪水因子对城市的影响相对较小。</modify></pre>
          </div>
        </div>
        <div>
          <h1 v-if="ChosedItem.some(item => item.startsWith('3'))">3 机构与职责</h1>
          <p v-if="ChosedItem.some(item => item.startsWith('3'))">
            <modify class="update">
              深圳
            </modify>市防汛防旱防风指挥部（以下简称市三防指挥部）为全市防汛工作的指挥机构，在市委市政府和上级防汛指挥机构指导下开展工作，由市政府分管副市长和指挥部成员单位负责人组成。指挥部成员由 <modify class="update">
            驻深解放军，武警部队，市委市政府相关部门、相关骨干企业
          </modify>组成。各区设立三防指挥部，负责本行政区域的防汛抢险救灾。有防汛抢险救灾任务的各成员单位成立专门防汛组织，负责本单位、本系统防汛工作。
          </p>
          ...
          <div v-if="ChosedItem.indexOf('3-2')!==-1">
            <h2>3.2 指挥工作小组</h2>
            <p>
              根据防汛需要，市三防指挥部划分成综合协调、抢险突击、综合救援、治安维稳、交通保障、物资保障、医疗救护及卫生防疫、工程抢险、灾民安置、次生灾害防治、公用设施保障、宣传12个指挥小组，具体指挥协调相关防汛抢险救灾工作，各指挥小组按照指挥部指令和预案启动运作，小组人员由相关单位抽调组建，牵头成员单位负责人任指挥小组组长，其它成员单位负责人任副组长。
            </p>
            <p>
              综合协调组：由市应急管理局、市水务局、市气象局、市发展改革委、市教育局、市规划和自然资源局、市文化广电旅游体育局、各区政府（管委会）等单位组成。负责指挥部的上传下达工作；及时收集掌握雨情、水情、险情、灾情、工情等各种防汛动态信息；组织协调防汛抢险救灾行动；负责有关协调联络工作。市应急管理局为牵头单位。综合协调组：由市应急管理局、市水务局、市气象局、市发展改革委、市教育局、市规划和自然资源局、市文化广电旅游体育局、各区政府（管委会）等单位组成。负责指挥部的上传下达工作；及时收集掌握雨情、水情、险情、灾情、工情等各种防汛动态信息；组织协调防汛抢险救灾行动；负责有关协调联络工作。市应急管理局为牵头单位。
            </p>
            <p>
              抢险突击组：由<modify class="update">
              深圳警备区、驻深部队、武警部队、民兵预备役等单位
            </modify>组成。负责部署和组织部队民兵救援力量、实施紧急救援行动、承担抢险和救援任务。<modify class="update">
              深圳警备区
            </modify>为牵头单位。
            </p>
            <p>
              综合救援组：由市消防支队和<modify class="update">
              深圳市
            </modify>其他常备专业救援队伍等单位组成。负责承担综合应急救援职责，抢救遇险人员，转移和疏散被困群众，协助地方人民政府开展灾后重建中的相关工作。市消防支队为牵头单位。
            </p>
            <p>
              治安维稳组：由市公安局和各区政府（管委会）等单位组成。负责灾区治安防控，依法严厉打击破坏抢险救灾行动和工程设施安全的行为，保证抢险救灾工作的顺利进行。市公安局为牵头单位
            </p>
            <p>
              交通保障组：由市交通运输局、市公安局、<modify class="update">
              市口岸办、深圳海事局、
            </modify>等单位组成。负责灾民疏散、撤退和紧急救援转移的交通保障，受灾片区树木清运、道路交通管制、高速公路封闭、轨道交通停运等。负责维护陆路海上交通秩序，疏导车辆船舶，确保处置重大突发灾情过程中交通顺畅。市交通运输局为牵头单位。
            </p>
            <p>
            ...
            <p>
            工程抢险组：由市规划和自然资源局、市住房建设局、市交通运输局、市水务局、市城管和综合执法局、市建筑工务署、市水务集团、<modify class="update">
              广东粤港供水有限公司、
            </modify>各区政府（管委会）、等单位组成。负责组织工程抢险施工力量；提供抢险技术方案；对各自职责范围内工程进行维护和抢修。各工程行政主管单位分别牵头。
            </p>
            <p>
              灾民安置组：由市应急管理局、市公安局、市财政局、各区政府（管委会）、等单位组成。负责灾情调查、救济款物的管理和发放、灾民的登记安置，解决灾民的吃、住、穿等基本生活问题，协助和配合医疗救护及卫生防疫组做好善后工作。市应急管理局为牵头单位。
            </p>
            <p>
            ...
            <p>
              公用设施保障组：由市应急管理局、市工业和信息化局、市住房建设局、市城管和综合执法局、市通信管理局、各区政府（管委会）、<modify class="update">
              深圳供电局有限公司、中国电信深圳分公司、中国移动深圳分公司、中国联通深圳分公司、中国铁塔深圳分公司、
            </modify>市水务集团、市燃气集团等单位组成。负责建立应急通信和供电系统；启用备用电源；组织专业抢修队，及时修复通信、供电、供水、供气等公用设施。市应急管理局为牵头单位。
            </p>
            <p>
              宣传组：由市委宣传部、市应急管理局、<modify class="update">
              深圳报业集团、深圳广电集团
            </modify>和处置突发事件主要单位等组成。收集整理组织防御和抢险救灾的信息，按规定及时、准确、全面地向市委市政府及市三防指挥部领导汇报。指导各新闻媒体开展抢险救灾宣传报道，正确引导舆论。市委宣传部为牵头单位。
            </p>
          </div>
          <div v-if="ChosedItem.indexOf('3-3')!==-1">
            ...
            <p>
              市公安局：负责维持社会治安、指挥灾民的疏散、撤退和陆地的突击救生；负责对道路交通事故进行快速处置，对涉水被困车辆实行紧急救援，协助受灾群众安全转移，确保抢险救灾车辆优先、快速通行。
            </p>
            <p>
            ...
            <p>
              <modify class="update">
                市口岸办：负责深圳口岸在暴雨期间对港交通、通关安全突发事件的应急处置工作；配合协调各口岸因暴雨滞留旅客的疏导工作，维护口岸公共秩序。
              </modify>
            </p>
            <p>
            ...
            <p>
              市地铁集团公司：负责做好在建地铁工地、运营线路及上盖物业的防汛工作。及时在地铁媒体上发布三防信息，组织开展场站和交通工具人员保护、疏散，组织抢险救灾。市地铁集团公司：负责做好在建地铁工地、运营线路及上盖物业的防汛工作。及时在地铁媒体上发布三防信息，组织开展场站和交通工具人员保护、疏散，组织抢险救灾。
            </p>
            <p>
              <modify class="update">
                深圳供电局有限公司、中国电信深圳分公司、中国移动深圳分公司、中国联通深圳分公司、中国铁塔深圳分公司：
              </modify>：负责防汛及抢险救灾期间的供电、电信、移动电话的通畅，及时抢修损坏的供电、电信设施。
            </p>
            <p>
        ...
        <div>
          <h1 v-if="ChosedItem.some(item => item.startsWith('4'))">4 暴雨预警</h1>
          <p>
          ...
          <p>
            暴雨预警信号发布后，各区、市直各单位按照<modify class="update">
            深圳市
          </modify>台风暴雨灾害防御规定等有关文件要求，做好各项防御准备工作。
          </p>
        </div>
        <div>
          <h1 v-if="ChosedItem.some(item => item.startsWith('5'))">5 应急响应</h1>
          ...
          <div v-if="ChosedItem.indexOf('5-2')!==-1">
            ...
            <p>
              （3）市工业和信息化局：关注暴雨动态，协调无线电通信设施抢修及保障，保障抢险救灾无线电通信顺畅。（3）市工业和信息化局：关注暴雨动态，协调无线电通信设施抢修及保障，保障抢险救灾无线电通信顺畅。
            </p>
            <p>
            ...
            <p >
              （11）市应急管理局：通知临时避难场所全部开放，及时告知公众；指导做好受灾群众的转移安置和组织协调灾民基本生活救助工作。准备好抢险救灾物资和器材的调配供应。督促危化品生产经营企业加强对危险部位（储罐区、配电房等）监控，发现险情应及时排除，无法排除的要立即采取应对措施，同时按规定上报。
            </p>
            <p >
            ...
            <p>
              <modify class="update">
                （14）深圳警备区：做好抢险救灾的相应准备，必要时迅速参与抢险救灾。
              </modify>
            </p>
            <p>
        ...
        <div>
          <h1 v-if="ChosedItem.some(item => item.startsWith('6'))">6 重点防洪区域人员转移方案</h1>
        ...
        <div>
          <h1 v-if="ChosedItem.some(item => item.startsWith('7'))">7 超标准洪水防御方案</h1>
          ...
          <div v-if="ChosedItem.indexOf('7-3')!==-1">
            <h2>
              7.3 超标准洪水防御措施
            </h2>
            <p>
        ...
        <div>
          <h1 v-if="ChosedItem.some(item => item.startsWith('8'))">8 善后处置</h1>
          <div v-if="ChosedItem.indexOf('8-1')!==-1">
            ...
            <p>
              8.1.2灾后工作在市政府统一领导下，由市三防指挥部具体部署，召开成员紧急会议，部署、协调有关救灾工作，必要时建议市政府召开救灾紧急会议；必要时由指挥部各成员单位组成工作组到抗灾第一线，慰问灾民，协助指导抗灾救灾；向省三防总指挥部报告汛情与灾情；收集灾情，并与有关部门共同会商，核实、汇总灾情；研究并采取措施对出现险情的工程进行加固，消除隐患。
            </p>
            <p>
            ...
            <p>
              8.1.8应急管理部门负责组织协助灾区安置和救济灾民，安排好灾民临时生活；解决灾民的基本生活保障；组织赈灾募捐工作；及时掌握各地安置灾民动态；协助指挥部收集、核实、汇总灾情。
            </p>
            <p>
          ...
          <div v-if="ChosedItem.indexOf('8-2')!==-1">
            ...
            <p>
              <modify class="update">
                8.2.3物资和劳务的征用补偿：防汛抢险期间，如征用了当地群众的物资，应按当地市场价格，经当地三防部门核定数量，由当地人民政府给予补偿；当地政府应对参与抢险的人员应给予适当补助；如调动 驻深部队市消防支队等抢险队伍，市财政局应拨出专项资金予以补助。
              </modify>
            </p>
            <p>
          ...
          <div v-if="ChosedItem.indexOf('8-3')!==-1">
            <h2>
              8.3 防汛工作评估
            </h2>
            <p>
        ...
        <div>
        <h1 v-if="ChosedItem.some(item => item.startsWith('9'))">9 保障措施</h1>
        <div v-if="ChosedItem.indexOf('9-1')!==-1">
          <h2>
            9.1 通信和信息保障
          </h2>
          <p>
          ...
          <p>
            <modify class="update">
              9.1.2 市工业和信息化局、市通信管理局、中国电信深圳分公司、中国移动深圳分公司、中国联通深圳分公司、中国铁塔深圳分公司负责防汛通信畅通。
            </modify>
          </p>
          <p>
        ...
        <div v-if="ChosedItem.indexOf('9-2')!==-1">
          <h2>
            9.2 抢险队伍保障
          </h2>
          <p>
          ...
          <p>主力队：
            <modify class="update">
              驻深解放军、武警部队、公安部队、市消防支队是我市防汛抢险的主力队伍，主要担负市内重大险情的抢护和抢救人民群众生命及重大财产、重点场所保护等任务。该抢险救灾队伍由市委市政府依法统一指挥和调度。
            </modify>
          </p>
          <p>
            专业队：
            <modify class="update">
              市三防指挥部成员单位组织各自所管行业的防汛抢险救灾队伍，协助配合驻深解放军、武警部队开展抢险救灾或单独负责所管行业内的抢险救灾工作。
            </modify>
          </p>
          <p>
        ...
        <div v-if="ChosedItem.indexOf('9-3')!==-1">
          <h2>
            9.3 供电与交通保障
          </h2>
          <p>
            9.3.1
            <modify class="update">
              深圳供电局有限公司负责抢险救灾等方面的供电需要和应急救援现场的临时供电。
            </modify>
          </p>
          <p>
            9.3.2 市交通运输局负责抢险人员、防汛救灾物资的运输保障工作。
          </p>
        </div>
        <div v-if="ChosedItem.indexOf('9-4')!==-1">
          <h2>
            9.4 治安与医疗保障
          </h2>
          <p>
        ...
        <div v-if="ChosedItem.indexOf('9-5')!==-1">
          <h2>
            9.5 物资保障
          </h2>
          <p>
        ...
        <div v-if="ChosedItem.indexOf('9-6')!==-1">
          <h2>
            9.6 技术保障
          </h2>
          <p>
        ...
        <div v-if="ChosedItem.indexOf('9-7')!==-1">
          <h2>
            9.7 社会动员保障
          </h2>
          <p>
        ...
        <div v-if="ChosedItem.indexOf('9-8')!==-1">
          <h2>
            9.8 宣传、培训和演练
          </h2>
          <p>
        ...
        <div>
          <h1 v-if="ChosedItem.some(item => item.startsWith('A'))">10 预案管理</h1>
          <div v-if="ChosedItem.indexOf('A-1')!==-1">
            <h2>
              10.1 预案修编增编
            </h2>
            <p>
          ...
          <div v-if="ChosedItem.indexOf('A-2')!==-1">
            <h2>
              10.2 预案报送备案
            </h2>
            <p>
          ...
          <div v-if="ChosedItem.indexOf('A-3')!==-1">
            <h2>
              10.3 预案操作要求
            </h2>
            <p>
...
<!--        <div>-->
<!--          <h1 v-if="ChosedItem.some(item => item.startsWith('0'))">仿真模拟结果</h1>-->
<!--          <p>-->
<!--            根据模拟仿真预测，需要支援100人，需要支援20辆车。需要注意的风险点包括：位置1、位置2、位置3、位置4、位置5、位置6、位置7、位置8-->
<!--          </p>-->
<!--        </div>-->
      </div>
    </div>
