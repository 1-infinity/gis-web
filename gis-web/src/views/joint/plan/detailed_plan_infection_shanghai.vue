      ...
      <div>
        <div>
          ...
          <div v-if="ChosedItem.indexOf('1-2') !== -1">
            ...
            <p>
              依据
              <modify class="update">
                《中华人民共和国传染病防治法》、《突发公共卫生事件应急条例》和《国家突发公共卫生事件应急预案》、《上海市突发公共事件总体应急预案》
              </modify>
              等法律法规及有关规定，制订本预案。
            </p>
          </div>
          <div v-if="ChosedItem.indexOf('1-3') !== -1">
            <h2>1.3 事件分级</h2>
            <p>
              Ⅰ.本预案所称的突发公共卫生事件，指突然发生、造成或者可能造成社会公众身心健康严重损害的传染病疫情、群体性不明原因疾病、以及其他严重影响公众健康和生命安全的事件。
            </p>
            <p>
            ...
            <p>①发现肺鼠疫病例，并有扩散趋势；</p>
            <p>②发现肺炭疽病例，并有扩散趋势；</p>
            <p>③发现传染性非典型肺炎、人感染高致病性禽流感病例，并有扩散趋势；</p>
            <p>④群体性不明原因疾病涉及包括本市在内的多个省份，并有扩散趋势；</p>
            <p>
              ⑤新传染病或我国尚未发现的传染病在本市发生或传入本市，并有扩散趋势，或发现我国已消灭的传染病在本市重新流行；</p>
            <p>⑥发生高致病性病菌株、毒株、致病因子等丢失事件；</p>
            <p>⑦周边以及与我国通航的国家和地区发生特大传染病疫情，本市出现输入性病例，严重危及公共卫生安全；</p>
            <p>⑧卫生部认定的其他特别重大突发公共卫生事件。</p>
            <p>6
              依据
              <modify class="update">《上海市突发公共事件总体应急预案》</modify>
              ，一次死亡3人以上列为报告和应急处置的重大事项。对涉外、敏感、可能恶化的事件，应加强情况报告并提高响应等级。
            </p>
          </div>
          <div v-if="ChosedItem.indexOf('1-4') !== -1">
            <h2>1.4 适用范围</h2>
            <p>本预案适用于本市突发公共卫生事件的应急处置。</p>
            <p>
              发生食物中毒、职业中毒、以及病原微生物实验室生物安全管理，按照其他有关规定执行。
            </p>
            <p>
              其他突发公共事件涉及的医疗卫生应急救援，依据
              <modify class="update">《上海市突发公共事件医疗卫生救援应急预案》</modify>
              实施应急处置
            </p>
          </div>
        ...
        <div>
          ...
          <div v-if="ChosedItem.indexOf('2-1') !== -1">
            ...
            <p>
              <modify class="update">《上海市突发公共事件总体应急预案》</modify>
              明确，本市突发公共事件应急管理工作由市委、市政府统一领导。市政府是突发公共事件应急管理工作的行政领导机构。市应急委决定和部署突发公共事件应急管理工作，其日常事务由市应急办负责。
            </p>
          </div>
        ...
        <div>
          ...
          <div v-if="ChosedItem.indexOf('3-1') !== -1">
            <h2>3.1 信息监测</h2>
            <p>
              Ⅰ.本市建立突发公共卫生事件监测、预警与报告网络体系。各级医疗机构、疾病预防控制机构、卫生监督机构和出入境检疫机构要根据各自职责，开展突发公共卫生事件的日常监测。
            </p>
            <p>
        ...
        <div>
          ...
          <div v-if="ChosedItem.indexOf('4-2') !== -1">
            ...
            <p>
              ...
              开展突发公共卫生事件的医疗卫生应急、信息发布、宣传教育、应急物资与设备的调集、后勤保障以及督导检查等工作。事发地的区县人民政府按照市政府或市政府有关部门的统一部署，结合本地区实际情况，组织协调开展突发公共事件的应急处理工作。
            </p>
            <p>
        ...
        <div>
          ...
          <p v-if="ChosedItem.some(item => item.startsWith('6'))">
...
export default {
  name: 'detailed_plan_infection_shanghai',
  props:
    {
      ChosedItem: {
        type: Array
