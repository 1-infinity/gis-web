      ...
      <div>
        <div>
          ...
          <div v-if="ChosedItem.indexOf('1-2')!==-1">
            <h2>1.2 编制依据</h2>
            <p>
              依据<modify class="update">《中华人民共和国水法》、《中华人民共和国防洪法》、《中华人民共和国气象法》、《中华人民共和国防汛条例》等法律、行政法规以及《国家防汛抗旱应急预案》、《国家突发公共事件总体应急预案》、《广东省防汛防旱防风工作的若干规定》等</modify>规范性文件，制定本预案。
            </p>
          </div>
          <div v-if="ChosedItem.indexOf('1-3')!==-1">
            <h2>1.3 适用范围</h2>
            <p>
              本预案适用于<modify class="update">珠海市</modify>范围内突发性水灾害的预防和应急处置。突发性水灾害包括：江河洪水、暴雨、洪涝灾害、山洪灾害（指由降雨引发的山洪、泥石流等），以及由洪水、风暴潮、地震、恐怖活动等引发的水库垮坝、堤防决口、水闸倒塌等次生衍生灾害。范围内突发性水灾害的预防和应急处置。突发性水灾害包括：江河洪水、暴雨、洪涝灾害、山洪灾害（指由降雨引发的山洪、泥石流等），以及由洪水、风暴潮、地震、恐怖活动等引发的水库垮坝、堤防决口、水闸倒塌等次生衍生灾害。
            </p>
          </div>
          <div v-if="ChosedItem.indexOf('1-4')!==-1">
            <h2>1.4 工作原则</h2>
            <p>
              ①坚持以人为本防汛工作方针，把保障人民群众生命财产安全作为三防工作的首要任务，最大限度地减少水灾害造成的危害和损失。
            </p>
            <p>
              ②防汛工作实行各级政府行政首长负责制，统一指挥，属地管理，分级分部门负责。
            </p>
            <p>
              ③防汛工作以防洪安全为首要目标，坚持安全第一、常备不懈、以防为主、全力抢险的方针和防抢救结合的原则。
            </p>
            <p>
              ④防汛工作按照流域、区域统一规划，坚持因地制宜，城乡统筹，突出重点，兼顾一般，局部服从全局利益。
            </p>
            <p>
              ⑤坚持依法防汛，实行公众参与、军民结合、专群结合、平战结合的原则。
            </p>
            <p>
              ⑥坚持防汛抗旱统筹，在防洪安全的前提下，尽可能利用洪水资源，促进人与自然和谐相处。
            </p>
            <p>
        ...
        <div>
          <h1 v-if="ChosedItem.some(item => item.startsWith('2'))">2 组织机构与职责</h1>
          <div v-if="ChosedItem.indexOf('2-1')!==-1">
            <h2>2.1 组织机构</h2>
            <p>
              市防汛防旱防风指挥部（以下简称“市三防指挥部”）负责全市的防汛工作，各区<modify class="update">（含各行政区、横琴新区、经济功能区，下同）</modify>三防指挥部负责本区域内的防汛工作。有关部门、单位根据实际需要设立防汛组织机构，制定和实施相应防汛抢险救灾工作预案，负责本部门、本单位和本行业的防汛工作。
            </p>
            <p>
              市三防指挥部由市政府分管三防工作的副市长任总指挥，下设市防汛防旱防风指挥部办公室（以下简称“市三防办”）为常设办事机构。<modify class="update">珠海警备区、武警市支队、市委办公室、市委宣传部、市应急办、市发展改革局、市教育局、市公安局、市监察局、市民政局、市财政局、市国土资源局、市建设局、市交通局、市港口局、市水务局、市农业局、市口岸局、市卫生局、市城管执法局、市市政园林和林业局、市气象局 、珠海海事局、珠海供电局、珠海水务集团、珠海海洋环境监测中心站、珠海电信公司、白蕉水文站</modify>和各区三防指挥部为市三防指挥部成员单位。当水灾害影响我市以及造成灾害时，各有关单位按照职能分工，积极主动做好防汛工作。
            </p>
          </div>
        ...
        <div>
          <h1 v-if="ChosedItem.some(item => item.startsWith('3'))">3 预防和预警机制</h1>
        ...
        <div>
          ...
          <div v-if="ChosedItem.indexOf('4-1')!==-1">
            ...
            <p>
              洪水应急响应级别以<modify class="update">西江马口站点洪峰出现的重现期</modify>划分：
            </p>
            <p><modify class="update">
              5～20年一遇，洪水灾害Ⅳ级应急响应。
            </modify></p>
            <p><modify class="update">
              20～50年一遇，洪水灾害III级应急响应。
            </modify></p>
            <p><modify class="update">
              50～100年一遇，洪水灾害Ⅱ级应急响应。
            </modify></p>
            <p><modify class="update">
              100年一遇以上，洪水灾害Ⅰ级应急响应。
            </modify></p>
            ...
            <p>
              暴雨灾害按预警信号，<modify class="update">划分为三个应急响应级别：Ⅰ级（特别严重）、Ⅱ级（严重）、Ⅲ级（一般）。市三防指挥部发布的暴雨灾害应急响应名称分别为：暴雨灾害Ⅰ级应急响应、暴雨灾害Ⅱ级应急响应、暴雨灾害Ⅲ级应急响应。</modify>
            </p>
            <p><modify class="update">
              III级（一般，预警信号为黄色）
            </modify></p>
        ...
        <div>
          <h1 v-if="ChosedItem.some(item => item.startsWith('5'))">5 应急响应行动</h1>
          <div v-if="ChosedItem.indexOf('5-1')!==-1">
            ...
            <p><modify class="update">
              （2）受洪水影响区域的三防部门加强值班，加强与 白蕉水文站的联系，密切关注洪水发展趋势，及时向同级和上级三防指挥部领导汇报最新情况，并将有关防御通知及防洪指示及时传达有关单位。
            </modify></p>
            <p>
              （3）各防洪单位检查防洪物资准备情况。
            </p>
            ...
            <p>
              （8）教育部门负责通知受洪水威胁的托儿所、幼儿园做好防洪工作，必要时实施停课措施。
            </p>
            <p>
              （9）民政部门负责开放受洪水影响区域的避护所，并将避护所开放和避护情况报市三防办。同时负责避护人员避护期间生活物资的保障工作。
            </p>
            <p>
              （10）交通部门负责提供抢险、群众转移车辆保障。
            </p>
            <p>
              （11）受洪水影响区域的三防部门组织相关单位对防洪工作落实情况进行检查，重点检查留滞江海边养殖、渔排、围内鱼塘、低洼地、危房、建筑工地、临时简易工棚等重点防御区域群众的转移工作落实情况。
            </p>
            <p>
              （12）宣传部门加强对防洪抢险工作的宣传报道。
            </p>
            <p>
              （13）受洪水影响区防汛抢险专家、抢险专业队伍随时准备进行抢险。
            </p>
            <p>
              ③洪水灾害II级应急响应
            </p>
        ...
        <div>
          ...
          <div v-if="ChosedItem.indexOf('6-7')!==-1">
            <h2>6.7 物资保障</h2>
            <p>
              ①防汛抢险物资保障
            </p>
          ...
          <div v-if="ChosedItem.indexOf('6-8')!==-1">
            <h2>6.8 经费保障</h2>
            <p>
        ...
        <div>
          <h1 v-if="ChosedItem.some(item => item.startsWith('7'))">7 善后工作</h1>
          <p>
        ...
        <div>
          <h1 v-if="ChosedItem.some(item => item.startsWith('8'))">8 预案管理</h1>
