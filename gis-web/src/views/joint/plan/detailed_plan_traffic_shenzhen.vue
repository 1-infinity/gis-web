<template>
  <div>
    <div id="exportContent">
      ...
      <div>
        <div>
          ...
          <div v-if="ChosedItem.indexOf('1-1')!==-1">
            ...
            为有效预防、及时处置
              深圳市
            各类道路交通（含桥梁、隧道）突发事件，最大程度地减少道路交通突发事件及其造成的人员伤亡和财产损失，提高本市应对道路交通突发事件的快速反应能力和应急处置能力，保障经济持续稳定发展和城市安全运行，特制订本预案。
            </p>
          </div>
          <div v-if="ChosedItem.indexOf('1-2')!==-1">
            ...
            <p>
              依据
                中华人民共和国道路交通安全法》、《中华人民共和国安全生产法》、《中华人民共和国消防法》、《中华人民共和国道路运输条例》、《城市道路管理条例》、《广东省突发事件总体应急预案》、《广东省道路运输保障应急预案》、《深圳市突发事件总体应急预案》、《深圳市城市道路管理办法》和《深圳市交通抢险工程管理办法》
              等法律法规和有关规定，制定本预案。
            </p>
          </div>
          <div v-if="ChosedItem.indexOf('1-3')!==-1">
            ...
            <p>
              （2）统一领导，职责明确，分工协作，分级管理，分级响应。
                在深圳市政府统一领导下，市区两级政府相关职能部门按照各自职责、分工、权限和本预案的规定，共同做好道路交通突发事件应急救援处置工作。
            </p>
            <p>
            ...
            <div v-if="ChosedItem.indexOf('1-4')!==-1">
              ...
              <p>
                a.造成3人以下死亡，或10人以下重伤（中毒），或危及3人以下生命安全；需要紧急疏散、转移较小区域范围内的人员。
              </p>
              <p>
                b.道路交通设施轻微损伤，导致交通需要部分封闭或改道，交通抢险工程规模1000万元以下；直接经济损失1000万元以下。
              </p>
              <p>
                较大道路交通突发事件（Ⅲ级）。
              </p>
              ...
              <p>
                a.造成3人以上、10人以下死亡（含失踪），或危及3人以上、10人以下生命安全，或10人以上、50人以下重伤（中毒）；需要紧急疏散、转移一定区域范围内的人员。
              </p>
              <p>
                b.道路设施较大损伤，导致交通中断，交通抢险工程规模1000万元以上；直接经济损失1000万元以上5000万元以下。
              </p>
              <p>
                重大道路交通突发事件（Ⅱ级）。
              </p>
              ...
              <p>
                a.造成10人以上、30人以下死亡（含失踪），或危及10人以上、30人以下生命安全，或50人以上、100人以下重伤（中毒）；需要紧急疏散、转移较大区域范围内的人员。
              </p>
              <p>
                b.道路交通设施严重损伤，导致交通中断，交通抢险工程规模1000万元以上；直接经济损失5000万元以上1亿元以下。
              </p>
              <p>
                c.超出本市应急处置能力的。
              </p>
              ...
              <p>
                a.造成30人以上死亡（含失踪），或危及30人以上生命安全，或100人以上重伤（中毒）；需要紧急疏散、转移特大区域范围内的人员。
              </p>
              <p>
                b.道路交通设施严重损伤，导致交通中断，交通抢险工程规模1000万以上；直接经济损失1亿元以上。
              </p>
              <p>
                c.超出本市应急处置能力的。
              </p>
            ...
            <div v-if="ChosedItem.indexOf('1-6')!==-1">
              <h2>1.6 突发事件现状</h2>
              <p>
                本预案适用于
                  深圳市
      ...
      <div>
        <h1 v-if="ChosedItem.some(item => item.startsWith('2'))">2 组织机构和职责</h1>
        ...
        <div v-if="ChosedItem.indexOf('2-2')!==-1">
          ...
          <p>
            市交通运输应急指挥部职责：贯彻执行预防和应对有关突发事件的法律、法规、规章和政策；起草和修订有关市交通运输应急预案，经市政府批准后实施；负责有关应急队伍的建设、管理和应急演练；建设和完善专业应急平台，纳入全市应急平台体系；统筹专业应急物资、装备的储备和调用；及时确定较大以上有关突发事件的等级与响应级别，按预案规定程序启动和结束应急响应，组织和指挥有关力量和资源参与事件处置工作；指挥、协调或协助各区开展有关突发事件应急预防和应对工作；开展专业应急宣传、教育和培训等工作；承办市委、市政府、市应急委交办的其他事项。
          </p>
          <p>
            市交通运输应急指挥部职责：贯彻执行预防和应对有关突发事件的法律、法规、规章和政策；起草和修订有关市交通运输应急预案，经市政府批准后实施；负责有关应急队伍的建设、管理和应急演练；建设和完善专业应急平台，纳入全市应急平台体系；统筹专业应急物资、装备的储备和调用；及时确定较大以上有关突发事件的等级与响应级别，按预案规定程序启动和结束应急响应，组织和指挥有关力量和资源参与事件处置工作；指挥、协调或协助各区开展有关突发事件应急预防和应对工作；开展专业应急宣传、教育和培训等工作；承办市委、市政府、市应急委交办的其他事项。
          </p>
          ...
          <p>
            （3）市经贸信息委：负责道路交通突发事件救援过程中生活必需品市场供应应急预案；负责协调
              深圳
            通信、网络相关单位落实通信、网络等应急装备的抢修和通信物资的储备。
          </p>
          <p>
          ...
          <p>
            （25）
              深圳
            供电局有限公司：负责所辖范围内的所辖电力设备设施的损坏修复及电力调度工作。确保灾区的电力供应，保障防灾抗灾救灾的用电及市交通运输应急指挥部各成员单位的日常用电。
          </p>
          <p>
      ...
      <div>
        <h1 v-if="ChosedItem.some(item => item.startsWith('3'))">3 运行机制</h1>
      ...
      <div>
        <h1 v-if="ChosedItem.some(item => item.startsWith('4'))">4 应急保障</h1>
        ...
        <div v-if="ChosedItem.indexOf('4-3')!==-1">
          <h2>4.3 物资保障</h2>
          <p>
            相关成员单位应按照《关于进一步加强我市应急物资储备工作的意见》（深府办函〔2011〕87号）有关要求，
            加强应急物资日常储备，建立应急物资生产能力、技术储备、产品储备信息数据库，加强相关物资储备、生产及加工能力储备、生产工艺流程的技术储备；制定应急物资调拨、配送方案，并建立应急物资紧急生产机制。各相关部门要根据道路交通突发事件的特点，配备必要的应急救援装备和救灾物资，并加强应急装备的管理、维护和保养。
          </p>
        </div>
        ...
        <div v-if="ChosedItem.indexOf('4-7')!==-1">
          <h2>4.7 人员防护保障</h2>
          <p>
      ...
      <div>
        <h1 v-if="ChosedItem.some(item => item.startsWith('5'))">5 监督管理</h1>
      ...
      <div>
        <h1 v-if="ChosedItem.some(item => item.startsWith('6'))">6 预案管理</h1>
        ...
        <div v-if="ChosedItem.indexOf('6-2')!==-1">
          ...
          <p>
            市交通运输应急指挥部办公室在出现下列情况之一时，对本预案进行修订，并报市人民政府审定：
          </p>
          <p>
            市交通运输应急指挥部办公室在出现下列情况之一时，对本预案进行修订，并报市人民政府审定：
          </p>
        ...
        <div v-if="ChosedItem.indexOf('6-3')!==-1">
          <h2>6.3 制定与解释</h2>
          <p>
            本预案是应对道路交通突发事件预案体系中的综合预案，由市交通运输委牵头制定和解释。
          </p>
        </div>
      </div>
    </div>
...
export default {
  name: 'detailed_plan_traffic_shenzhen',
  props:
    {
      ChosedItem: {
        type: Array
